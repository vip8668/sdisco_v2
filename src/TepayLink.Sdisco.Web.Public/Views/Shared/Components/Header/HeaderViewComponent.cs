...
using TepayLink.Sdisco.Web.Public.Startup;
using TepayLink.Sdisco.Web.Session;

namespace TepayLink.Sdisco.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : SdiscoViewComponent
    {
