...
namespace TepayLink.Sdisco.Web.Public.Startup
{
    ...
    public class SdiscoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public SdiscoWebFrontEndModule(IWebHostEnvironment env, SdiscoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SdiscoWebFrontEndModule).GetAssembly());
        }
    }
}
