...
using MvvmHelpers;
using TepayLink.Sdisco.Authorization.Users.Profile;
using TepayLink.Sdisco.Authorization.Users.Profile.Dto;
using TepayLink.Sdisco.Commands;
using TepayLink.Sdisco.Core.Threading;
using TepayLink.Sdisco.Models.NavigationMenu;
using TepayLink.Sdisco.Services.Navigation;
using TepayLink.Sdisco.ViewModels.Base;
using Plugin.Media;
...
using TepayLink.Sdisco.ApiClient;
using TepayLink.Sdisco.Controls;
using TepayLink.Sdisco.Dto;
using TepayLink.Sdisco.Extensions;
using TepayLink.Sdisco.Localization;
using TepayLink.Sdisco.UI;
using TepayLink.Sdisco.UI.Assets;
using TepayLink.Sdisco.Views;
using DependencyResolver = TepayLink.Sdisco.Core.Dependency.DependencyResolver;

namespace TepayLink.Sdisco.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Sdisco";
