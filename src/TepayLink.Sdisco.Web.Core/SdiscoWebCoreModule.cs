...
using TepayLink.Sdisco.Web.Configuration;
using TepayLink.Sdisco.Web.DashboardCustomization;

namespace TepayLink.Sdisco.Web
{
    [DependsOn(
        typeof(SdiscoApplicationModule),
        typeof(SdiscoEntityFrameworkCoreModule),
    ...
    public class SdiscoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SdiscoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(SdiscoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SdiscoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(SdiscoWebCoreModule).Assembly);
        }
