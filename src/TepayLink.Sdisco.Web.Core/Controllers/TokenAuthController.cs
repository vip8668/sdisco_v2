...
using TepayLink.Sdisco.Web.Authentication.JwtBearer;
using TepayLink.Sdisco.Web.Authentication.TwoFactor;
using TepayLink.Sdisco.Web.Models.TokenAuth;
...
namespace TepayLink.Sdisco.Web.Controllers
{
    ...
    public class TokenAuthController : SdiscoControllerBase
    {
