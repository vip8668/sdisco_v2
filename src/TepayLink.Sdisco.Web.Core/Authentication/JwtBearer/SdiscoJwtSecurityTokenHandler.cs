...
namespace TepayLink.Sdisco.Web.Authentication.JwtBearer
{
    public class SdiscoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public SdiscoJwtSecurityTokenHandler()
        {
