...
namespace TepayLink.Sdisco.Core.Base
{
    public abstract class SdiscoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected SdiscoQueryBase(string fieldName,
