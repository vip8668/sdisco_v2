...
using TepayLink.Sdisco.MultiTenancy.Demo;
...
namespace TepayLink.Sdisco.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(SdiscoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
