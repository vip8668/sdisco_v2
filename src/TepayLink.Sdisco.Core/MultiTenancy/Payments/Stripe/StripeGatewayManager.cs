...
{
    public class StripeGatewayManager : SdiscoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Sdisco";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + SdiscoConsts.Currency;
        }
