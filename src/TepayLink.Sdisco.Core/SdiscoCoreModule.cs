...
using TepayLink.Sdisco.Authorization.Ldap;
...
using TepayLink.Sdisco.DashboardCustomization.Definitions;
using TepayLink.Sdisco.Debugging;
using TepayLink.Sdisco.Features;
...
using TepayLink.Sdisco.Net.Emailing;
using TepayLink.Sdisco.Notifications;
using TepayLink.Sdisco.WebHooks;

namespace TepayLink.Sdisco
{
    [DependsOn(
        typeof(SdiscoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class SdiscoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            SdiscoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = SdiscoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, SdiscoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<SdiscoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SdiscoCoreModule).GetAssembly());
        }
