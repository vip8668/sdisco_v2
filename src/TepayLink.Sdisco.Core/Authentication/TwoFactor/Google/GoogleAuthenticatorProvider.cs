...
namespace TepayLink.Sdisco.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : SdiscoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("TepayLink.Sdisco", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
