...
using TepayLink.Sdisco.DemoUiComponents.Dto;

namespace TepayLink.Sdisco.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : SdiscoAppServiceBase, IDemoUiComponentsAppService
    {
