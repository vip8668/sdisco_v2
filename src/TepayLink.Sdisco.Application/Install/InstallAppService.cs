...
namespace TepayLink.Sdisco.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : SdiscoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<SdiscoDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(SdiscoConsts.ConnectionStringName).Value.ToString();
        }
