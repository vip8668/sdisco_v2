...
{
    public class SessionAppService : SdiscoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = SdiscoConsts.Currency,
                    CurrencySign = SdiscoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = SdiscoConsts.AllowTenantsToChangeEmailSettings
                }
            };
