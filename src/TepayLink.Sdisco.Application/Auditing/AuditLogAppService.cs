...
using TepayLink.Sdisco.Auditing.Exporting;
using TepayLink.Sdisco.Authorization;
using TepayLink.Sdisco.Authorization.Users;
using TepayLink.Sdisco.Dto;
using TepayLink.Sdisco.EntityHistory;
using EntityHistoryHelper = TepayLink.Sdisco.EntityHistory.EntityHistoryHelper;

namespace TepayLink.Sdisco.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : SdiscoAppServiceBase, IAuditLogAppService
    {
