...
using TepayLink.Sdisco.EntityFrameworkCore.Repositories;

namespace TepayLink.Sdisco.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : SdiscoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<SdiscoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
