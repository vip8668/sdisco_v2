...
namespace TepayLink.Sdisco.Web.Areas.Admin.Views.Shared.Components.AdminSubscriptionBar
{
    public class AdminSubscriptionBarViewComponent : SdiscoViewComponent
    {
