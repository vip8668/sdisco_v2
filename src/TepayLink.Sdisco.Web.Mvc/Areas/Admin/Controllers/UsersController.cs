...
using TepayLink.Sdisco.Web.Areas.Admin.Models.Roles;
using TepayLink.Sdisco.Web.Areas.Admin.Models.Users;
...
namespace TepayLink.Sdisco.Web.Areas.Admin.Controllers
{
    ...
    public class UsersController : SdiscoControllerBase
    {
