...
namespace TepayLink.Sdisco.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class SdiscoScriptSrcTagHelper : TagHelper
    {
        ...
        public SdiscoScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
