...
namespace TepayLink.Sdisco.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<SdiscoDbContext>>()
            ...
            new SdiscoDbContext(builder.Options).Database.EnsureCreated();
        }
